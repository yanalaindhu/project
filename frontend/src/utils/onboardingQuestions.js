export const LIFE_CONTEXT_QUESTIONS = {
  occupation: {
    ...
    options: [
      ...
      { id: "other", label: "⚙️ Other", desc: "None of the above match my daily focus" },
    ]
  },
  dailyRoutine: {
    ...
    options: [
      ...
      { id: "mostly_desk_work", label: "🖥️ Mostly Desk Work", desc: "Sitting, computer screens, meetings" },
...
export const EMOTION_QUESTIONS = {
  ...
  triggers: {
    ...
    options: [
      ...
      { id: "other", label: "⚙️ Other factors" },
    ]
  }
};
...
export const WELLBEING_DRIVERS_QUESTION = {
  ...
  options: [
    ...
    { id: "relationships", label: "❤️ Relationships", desc: "Partners, friendships, social circles" },
    ...
    { id: "other", label: "⚙️ Other", desc: "Miscellaneous factors not listed" },
  ]
};
...
export const STRESS_QUESTIONS = [
  ...
  { id: "difficultToDisconnect", label: "🔌 I find it difficult to disconnect from work/studies." },
...
export const BODY_QUESTIONS = {
  ...
  activity: {
    ...
    options: [
      { id: "sedentary", label: "🛋️ Sedentary", desc: "Little to no exercise, mostly sitting" },
  ...
  energeticTime: {
    ...
    options: [
      ...
      { id: "afternoon", label: "☀️ Afternoon", desc: "Mid-day to dusk (12 PM - 5 PM)" },
...
export const PRODUCTIVE_HOURS_QUESTION = {
  ...
  options: [
    ...
    { id: "morning", label: "☀️ Morning", desc: "8:00 AM - 12:00 PM" },
...
export const LIFESTYLE_QUESTIONS = [
  ...
  { id: "focused", label: "🎯 I stay focused during work/studies", isReversed: true },
  ...
  { id: "balance", label: "⚖️ I balance work and personal life", isReversed: true },
];
...
export const GOALS_QUESTION = {
  ...
  options: [
    ...
    { id: "improve_mental_health", label: "❤️ Improve Mental Health", icon: "Heart" },
    { id: "reduce_screen_time", label: "📵 Reduce Screen Time", icon: "MonitorOff" },
    { id: "better_work_life_balance", label: "⚖️ Better Work-Life Balance", icon: "Clock" },
  ]
};
